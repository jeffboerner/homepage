...
// Type 'd' to draw the grid diagram

// Type 'g' to start the animation
...
void drawKnot() {
  ...
  for (int i = 0;i < gridSize; i++) {
    ...
    if (knotDepth*r == 0) {
      ...
      sline(100 + colWidth*i + colWidth/2, 100+colWidth*y1Index+ colWidth/2+1, knotDepth*r, 100 + colWidth*i + colWidth/2, 100+colWidth*y1Index+ colWidth/2, 0);
      sline(100 + colWidth*i+ colWidth/2, 100+colWidth*y2Index+ colWidth/2+1, knotDepth*r, 100 + colWidth*i+ colWidth/2, 100+colWidth*y2Index+ colWidth/2, 0);
    }
    else {
    ...
    if (knotDepth*r == 0) {
      ...
      if (crossingIndex == -1) {
        ...
        if (crossingIndex > x1Index) {
          sline(100+colWidth*x1Index+ colWidth/2, 100+colWidth*j+colWidth/2, knotDepth*r, 100+colWidth*crossingIndex+colWidth/4, 100 + colWidth*j+colWidth/2, knotDepth*r);
          sline(100+colWidth*crossingIndex+ 3*colWidth/4, 100+colWidth*j+colWidth/2,0, 100+colWidth*x2Index+colWidth/2, 100 + colWidth*j+colWidth/2,0);
        }
        else {
          sline(100+colWidth*x2Index+ colWidth/2, 100+colWidth*j+colWidth/2, 0, 100+colWidth*crossingIndex+colWidth/4, 100 + colWidth*j+colWidth/2, 0);
          sline(100+colWidth*crossingIndex+ 3*colWidth/4, 100+colWidth*j+colWidth/2, 0, 100+colWidth*x1Index+colWidth/2, 100 + colWidth*j+colWidth/2, 0);
        }
      }

      //line(100+colWidth*x1Index+colWidth/2, 100+colWidth*j+colWidth/2, 100+colWidth*x2Index+colWidth/2, 100 + colWidth*j+colWidth/2);
    }
    else {
      // (k)not in plane
      fill(0, 0, 0);
